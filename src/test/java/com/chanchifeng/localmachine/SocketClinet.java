package com.chanchifeng.localmachine;

import com.chanchifeng.localmachine.common.JsonConverter;
import com.chanchifeng.localmachine.model.socket.model.LoginRequest;
...
public class SocketClinet {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SocketClinet.class);
